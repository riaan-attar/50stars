...
const AboutHero: React.FC = () => {
  ...
  const teamMembers = [
    { name: "James Anderson", role: "Head of Operations", image: "/assets/about-team-member-1.webp" },
    { name: "Michael Turner", role: "Lead CNC Engineer", image: "/assets/about-team-member-2.webp" },
    { name: "Olivia Bennett", role: "Quality Manager", image: "/assets/about-team-member-3.webp" },
    { name: "William Harris", role: "Production Supervisor", image: "/assets/about-team-member-4.webp" },
    { name: "Sophie Walker", role: "Client Relations Manager", image: "/assets/about-team-member-5.webp" },
    { name: "William Carter", role: "Project Manager", image: "/assets/about-team-member-6.webp" },
    { name: "Emily Carter", role: "Operations Specialist", image: "/assets/about-team-member-7.webp" }
  ];
  return (
          ...
          <div className="about-hero-content">
            <div className="about-hero-left">
              <div className="about-hero-avatars">
                ...
                <div className="avatar-counter-badge">10+</div>
              </div>
              <p className="about-hero-desc">Team of passionate professionals</p>
            </div>
      ...
      <section className="about-image-section">
        <div className="about-image-grid">
          ...
          <div className="about-img-left">
            <img src="/assets/about-building.png" alt="Precision manufacturing facility building" />
          </div>
          ...
          <div className="about-info-right">
            <div className="about-info-content">
              <p className="about-info-desc">
                We are a team dedicated to precision engineering, delivering solutions that shape industries worldwide. Our journey is defined by trust, quality, and a commitment to excellence in every project.
              </p>
              ...
              <div className="about-info-buttons">
                ...
                <a 
                  ...
                  download="manufact-brochure.pdf" 
                  target="_blank" 
                  rel="noreferrer"
                >
                  Download brochure
        ...
        <div className="about-journey-container">
          ...
          <div className="about-journey-header">
            ...
            <h2 className="about-journey-title">
              Engineering trust and <span className="text-orange">quality</span> through years of manufacturing experience
            </h2>
          </div>
            ...
            <div className="about-journey-info">
              ...
              <div className="about-caps-col">
                ...
                <div className="caps-list">
                  <a href="/service/product-assembly" className="cap-list-item">
                    <span>Product assembly</span>
                    <div className="cap-arrow-wrap">
                      <img src="/assets/about-arrow-orange.svg" alt="Arrow" />
                    </div>
                  </a>
                  <a href="/service/sheet-metal-fabrication" className="cap-list-item">
                    <span>Sheet metal fabrication</span>
                    <div className="cap-arrow-wrap">
                      <img src="/assets/about-arrow-orange.svg" alt="Arrow" />
                    </div>
                  </a>
                  <a href="/service/cnc-machining-services" className="cap-list-item">
                    <span>CNC machining services</span>
                    <div className="cap-arrow-wrap">
                      <img src="/assets/about-arrow-orange.svg" alt="Arrow" />
                    </div>
                  </a>
                  <a href="/service/injection-molding" className="cap-list-item">
                ...
                <div className="caps-cta-btn">
                  <a className="btn-meet-team" href="/service">
                    <div className="btn-meet-text-container">
        ...
        <div className="about-client-container">
          ...
          <div className="about-client-awards-section">
            <h3 className="about-client-awards-title">
              <span className="text-orange">20 Years</span> of manufacturing excellence &amp; recognition
            </h3>
        ...
        <div className="about-video-container">
          <div className="about-video-content">
            <div className="about-video-text-top">
              ...
              <h2>Delivering quality across industries and borders.</h2>
            </div>
            
            <div className="about-video-text-bottom">
              <div className="video-counter-wrap">
                <AnimatedNumber value={47648} />+
              </div>
              <p>Global delivery. Precision assured</p>
            </div>
          </div>
        </div>
          ...
          <div className="about-team-grid">
            ...
            <div className="about-team-left-col">
              ...
              <h2 className="about-team-title">
                Leaders in <span className="text-orange">precision</span> work
              </h2>
